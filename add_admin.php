    ...
    <section class="banner-area organic-breadcrumb">
		<div class="container">
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				...
				<div class="col-lg-5 addadmin">
					<div style="padding-top: 20px" class="login_form_inner">
						<h2>Add Admin</h2>
						<form class="row login_form" action="add_admin_post.php" method="post" id="contactForm" enctype="multipart/form-data">
							...
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" name="submit" class="primary-btn">Add Admin</button>
